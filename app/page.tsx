...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "모집 중이거나 진행 중인 의뢰는 누구나 제목·설명·예산을 볼 수 있습니다(비공개 협의 대화와 계좌 정보는 예외). 첨부 사진은 로그인한 사용자만 볼 수 있습니다. 제목·설명에 전화번호·이메일 등 개인정보로 보이는 내용을 적으면 저장할 때 자동으로 가려집니다. 완료된 의뢰는 등록 시 선택한 공개 여부에 따라 다르며, 비공개로 설정했다면 의뢰자와 선택된 제작자만 볼 수 있습니다.",
  },
  {
