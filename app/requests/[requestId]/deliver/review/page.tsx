...
import { deliverPublishAnywayAction } from "@/app/requestActions";
import { SEVERITY_LABEL, SEVERITY_ORDER, SEVERITY_STYLE } from "@/lib/severityStyle";
import { DeliverRescanForm } from "./DeliverRescanForm";
    ...
    <main className="mx-auto w-full max-w-2xl flex-1 px-6 py-10">
          ...
          {sortedFindings.map((finding) => (
            ...
            >
              ...
              {finding.aiFalsePositiveNote && (
                ...
                // 화면에만 참고 정보로 보여준다. 의뢰자 화면에는 노출 안 됨.
      ...
      <section className="mt-6 rounded-xl border border-zinc-200 p-5 dark:border-zinc-800">
        ...
        <DeliverRescanForm
          ...
          defaultCodeUrl={listing.codeUrl ?? undefined}
          defaultDeliveryGuide={selectedProposal.deliveryGuide ?? undefined}
        />
      </section>
    </main>
  );
