      ...
      <div className="mt-10 flex flex-col gap-10">
        <section>
          ...
          <ul className="mt-3 list-disc space-y-2 pl-5 text-sm leading-relaxed text-zinc-700 dark:text-zinc-300">
            ...
            <li>
              ...
              납품하고 대금을 직접 이체받으려는 제작자만 입력). 의뢰자가 완성본을 수락하고 이체를 완료로
              표시할 때: 이체 증빙 스크린샷(선택)
            </li>
            <li>
        ...
        <section>
          ...
          <ul className="mt-3 list-disc space-y-2 pl-5 text-sm leading-relaxed text-zinc-700 dark:text-zinc-300">
            ...
            <li>
              직거래 정산 안내 - 완성본을 수락한 의뢰자에게 제작자의 정산 계좌 정보를 확인시켜 대금
        ...
        <section>
          ...
          <ul className="mt-3 list-disc space-y-2 pl-5 text-sm leading-relaxed text-zinc-700 dark:text-zinc-300">
            ...
            <li>
              ...
              않으며, 의뢰자가 완성본을 수락한 이후 그 거래의 의뢰자 본인에게만 대금 이체를 위해
              한시적으로 공개됩니다.
            </li>
            <li>
              완성본 작동 증빙(스크린샷·영상)과 이체 증빙 스크린샷은 해당 거래의 의뢰자와 선택된
              제작자만 열람할 수 있으며, 그 외에는 공개되지 않습니다.
            </li>
            <li>
              완료된 의뢰는 의뢰자가 등록 시 또는 완료 후 언제든 설정할 수 있는 &quot;완료 후 의뢰 내용
              공개&quot; 설정이 켜져 있는 경우에만 제목·필요 프로그램/환경·요구사항 본문·소요기간·완료일이
              로그인하지 않은 방문자를 포함해 공개됩니다. 예산 금액, 첨부 이미지, 작동 증빙, 비공개
              협의 내용, 정산 계좌 정보, 이메일, 완성본 파일은 이 설정과 무관하게 항상 비공개입니다.
              제작자의 이름과 프로필 링크는 의뢰자가 별도로 &quot;제작자 귀속 표시&quot;에 동의한 경우에만
              함께 표시됩니다. 이 정책이 도입되기 전에 이미 완료된 의뢰는 의뢰자가 직접 공개로 설정하지
              않는 한 소급 공개되지 않습니다.
            </li>
          </ul>
          <p className="mt-4 text-sm leading-relaxed text-zinc-700 dark:text-zinc-300">
        ...
        <section>
          ...
          <ul className="mt-3 list-disc space-y-2 pl-5 text-sm leading-relaxed text-zinc-700 dark:text-zinc-300">
            ...
            <li>
              ...
              의뢰자가 해당 거래의 완성본을 수락한 뒤에만, 그 거래의 의뢰자 본인에게만 조회됩니다.
            </li>
